...
class PrestasiLinginPage extends StatelessWidget{
  final List<Map<String, dynamic>> dataPrestasi = [
    {'nama': 'Nama Prestasi 1', 'photo': 'assets/profilepict.jpg' },
    {'nama': 'Nama Prestasi 2', 'photo': 'assets/profilepict.jpg'},
    {'nama': 'Nama Prestasi 3', 'photo': 'assets/profilepict.jpg'},
  ];
          ...
          children: [ 
            Container(
              ...
              child: Container( 
                ...
                child: Center( 
                  child: Text( 
                    'Prestasi Mahasiswa Program Studi Linguistik Indonesia',
                    style: TextStyle( 
                      color: Colors.white,
                      fontSize: 16,
