...
class WebLinginPage extends StatelessWidget {
  @override
              ...
              child: Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Website Resmi Prodi Linguistik Indonesia',
                        style: TextStyle(
                          fontSize: 14,
                          fontWeight: FontWeight.bold,
                      ...
                      GestureDetector( 
                        onTap: (){ 
                          _launchURL('https://linguistik.upnjatim.ac.id/');
                        },
                        child: Text(
                        'https://linguistik.upnjatim.ac.id/',
                        style: TextStyle(
                          fontSize: 14,
